...
import setSegoeMDL2AssetsFonts from "./fonts";
import { getStyleValue } from "./StyleManager";
...
export default function getTheme(themeConfig = {}) {
  let {
    themeName,
    accent,
  ...
  const theme = {
    ...
    chromeBlackLow: tinycolor("#000")
      .setAlpha(0.2)
      .toRgbString(),
    chromeBlackMediumLow: tinycolor("#000")
      .setAlpha(0.4)
      .toRgbString(),
    chromeBlackMedium: tinycolor("#000")
      .setAlpha(0.8)
      .toRgbString(),
    chromeBlackHigh: "#000",
    chromeWhite: "#fff",
    ...
    fixStyle(style) {
      ...
      Object.keys(style).forEach(key => {
        style[key] = getStyleValue(key, style[key]);
      });
    },
    ...
    generateAcrylicTextures(currTheme, themeCallback = () => {}) {
